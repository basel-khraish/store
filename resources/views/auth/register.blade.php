...
<body>
    <div class="container">
        <main class="signup-container">
            ...
            <p class="text-mute">Enter your information to create a new account.</p>
            ...
            <form method="POST" action="{{ route('register') }}" class="signup-form">
                ...
                <label class="inp">
                    <input id="name" type="name" class="input-text @error('name') is-invalid @enderror"
            ...
            <p class="text-mute">Not a member? <a href="{{ route('login') }}">Login</a></p>
        </main>
