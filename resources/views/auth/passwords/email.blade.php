...
<head>
    ...
    <title>{{ 'Forgot Your Password | ' . env('APP_NAME') }}</title>
...
<body>
    <div class="container">
        <main class="signup-container">
            <h1 class="heading-primary">Restart Password<span class="span-blue">.</span></h1>
            <p class="text-mute">Get your password back.</p>
            ...
            <form method="POST" action="{{ route('password.email') }}" class="signup-form">
                ...
                <button class="btn btn-login">Send Password Reset Link</button>

            </form>
            <p class="text-mute">Not a member? <a href="{{ route('register') }}">Sign up</a></p>
            <p class="text-mute">Already a member? <a href="{{ route('login') }}">Login</a></p>
        </main>
